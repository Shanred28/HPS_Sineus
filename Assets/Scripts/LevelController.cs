...
public class LevelController : MonoBehaviour
{
    ...
    [Inject]
    public void Construct(IEntityFactory entityFactory, GameManager gameManager, PlayerHP playerHP, MarkToFinishPoint markToFinishPoint, KillZone killZone)
    {
    ...
    private void Awake()
    {
        ...
        _killZone.OnFinishKillZone += FinishLevel;
        _score = 0;
    }
